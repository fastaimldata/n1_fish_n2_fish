...
def prepare_submission():
    ...
    try:
        ...
        cls_models = [
            ...
            ('resnet50', 0.4, '../output/classification_results_test_combined/{}/resnet50/{}_categories.csv'),
    ...
    orig_submission.to_csv('../output/submission19.csv', index=False, float_format='%.8f')
