...
weights = {
    1: '../output/checkpoints/classification/model_inception_fold_1/checkpoint-004-0.1108.hdf5',
    2: '../output/checkpoints/classification/model_inception_fold_2/checkpoint-004-0.1271.hdf5',
    3: '../output/checkpoints/classification/model_inception_fold_3/checkpoint-006-0.1573.hdf5',
